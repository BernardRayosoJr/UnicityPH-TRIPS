...
/**
 * Generated class for the TokyoRanksSecondpagePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-tokyo-ranks-secondpage',
  templateUrl: 'tokyo-ranks-secondpage.html',
})
export class TokyoRanksSecondpagePage implements OnInit {
